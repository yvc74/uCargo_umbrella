...
export class SetupDeliveryCalendar {
  
  configure() {
    var elements = {
    // Input element
    input : document.getElementById("planning_order_delivery_schedule"),
    // Calendar element
    calendar : document.getElementById("date-delivery-picker-calendar"),
    // Close btn
    close : document.createElement('close_pick_up')
    }
